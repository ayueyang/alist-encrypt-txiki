...
> **2026-09-25 源码增量提示**：C-24 与 C-11 新增的异常路径补丁仅完成 Node 隔离回归 5/5 与临时 staging 编译；下方 “guest 已通过” 仅代表当时发布的 r10/之前版本，非本轮源码补丁的目标平台验收。详见 [增量审查 §11](porting-code-review.md)。
